...
public class INumericEntryTest extends ModelTest {

    @Test()
	public void testConstructor1(){
            String name = "Entry 1";
            NumericEntry entry = factory.createNumericEntry(name);
	...
	public void testConstructor2(){
            ...
            NumericEntry entry = factory.createNumericEntry(name, displayText);
            AssertJUnit.assertEquals("Entry has the wrong name",name,entry.getName());
	...
	public void testConstructor3(){
            ...
            NumericEntry entry = factory.createNumericEntry(name, status);
            AssertJUnit.assertEquals("Entry has the wrong name",name,entry.getName());
	...
	public void testConstructor4(){
            ...
            String displayText = "Display text";
            EntryStatus status = EntryStatus.OPTIONAL;
            NumericEntry entry = factory.createNumericEntry(name, displayText, status);
            AssertJUnit.assertEquals("Entry has the wrong name",name,entry.getName());
            AssertJUnit.assertEquals("Entry has the wrong status",status,entry.getEntryStatus());
            AssertJUnit.assertEquals("Entry has the wrong display text",displayText,entry.getDisplayText());
    }
	...
	public void testGenerateValue_Blank(){
            ...
            AssertJUnit.assertTrue("Generated value is not a INumericValue",value instanceof INumericValue);
            INumericValue nv = (INumericValue)value;
