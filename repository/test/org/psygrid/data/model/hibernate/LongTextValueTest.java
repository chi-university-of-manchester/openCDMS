...
public class LongTextValueTest {
	...
	public void testToDTO(){            
            ...
            ltv.setDeprecated(deprecated);
            
            Map<Persistent, org.psygrid.data.model.dto.PersistentDTO> dtoRefs = new HashMap<Persistent, org.psygrid.data.model.dto.PersistentDTO>();
            org.psygrid.data.model.dto.LongTextValueDTO dtoLTV = ltv.toDTO(dtoRefs, RetrieveDepth.RS_COMPLETE);

            AssertJUnit.assertNotNull("DTO boolean value is null", dtoLTV);
            AssertJUnit.assertEquals("DTO boolean value does not have the correct deprecated flag",deprecated,dtoLTV.isDeprecated());
            AssertJUnit.assertEquals("DTO boolean value does not have the correct value",value,dtoLTV.getValue());
    }
	...
	public void testIsNull(){
            LongTextValue bv = new LongTextValue();
