...
public class PanssTest extends DAOTest {
    ...
    public void testPanssReport(){
        try{
            ...
            Long repId = reportingDAO.saveReport(panssRep.toDTO());
            ...
            org.psygrid.data.reporting.RecordReport report = reportingDAO.generateReport(repId, rId, requestor, null);
            ...
            assertEquals("Summary chart row 1 has the wrong label", subPosText, chart1.getRows()[0].getSeries()[0].getLabel());
            assertEquals("Summary chart row 1 has the wrong number of series", 5, chart1.getRows()[0].getSeries().length);
            ...
            assertEquals("Scores chart row 1 has the wrong label", delLabel, chart2.getRows()[0].getSeries()[0].getLabel());
            assertEquals("Scores chart row 1 has the wrong number of series", 6, chart2.getRows()[0].getSeries().length);
