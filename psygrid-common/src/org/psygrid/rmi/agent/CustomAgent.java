 ...
 * port "org.psygrid.rmi.agent.port".
 * 
 * Adapted from this - http://blogs.oracle.com/jmxetc/entry/connecting_through_firewall_using_jmx
 * 
 */
public class CustomAgent {
	...
	throws IOException {
        ...
        final int port= Integer.parseInt(
                System.getProperty("org.psygrid.rmi.agent.port","3000"));
        ...
        // TMC - use 'localhost' as we're going to use an ssh tunnel
