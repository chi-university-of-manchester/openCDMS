...
public class Reports {
    ...
    public static IReport cpmMgmtReport(DataSet ds) throws ReportException {
        ...
        IManagementReport report = factory.createManagementReport(ds, "EDIE Test - Recruitment Manager Report");
    ...
    public static IReport ciMgmtReport(DataSet ds) throws ReportException {
        ...
        IManagementReport report = factory.createManagementReport(ds, "EDIE Test - Chief Investigator Report");
    ...
    public static IReport piManchesterMgmtReport(DataSet ds) throws ReportException {
        ...
        IManagementReport report = factory.createManagementReport(ds, "EDIE Test - Principal Investigator (Bristol Avon Hub) Report");
        report.setEmailAction(RBACAction.ACTION_DR_INVESTIGATOR_REPORT);
        report.setViewAction(RBACAction.ACTION_DR_VIEW_MGMT_REPORT);
    ...
    public static IReport piBirminghamMgmtReport(DataSet ds) throws ReportException {
        ...
        IManagementReport report = factory.createManagementReport(ds, "EDIE Test - Principal Investigator (East Anglia Hub) Report");
        report.setEmailAction(RBACAction.ACTION_DR_INVESTIGATOR_REPORT);
        report.setViewAction(RBACAction.ACTION_DR_VIEW_MGMT_REPORT);
    ...
    public static IReport piCambridgeMgmtReport(DataSet ds) throws ReportException {
        ...
        IManagementReport report = factory.createManagementReport(ds, "EDIE Test - Principal Investigator (East Midlands Hub) Report");
        report.setEmailAction(RBACAction.ACTION_DR_INVESTIGATOR_REPORT);
        report.setViewAction(RBACAction.ACTION_DR_VIEW_MGMT_REPORT);
    ...
    public static IReport piEastAngliaMgmtReport(DataSet ds) throws ReportException {
        ...
        IManagementReport report = factory.createManagementReport(ds, "EDIE Test - Principal Investigator (North East Hub) Report");
        report.setEmailAction(RBACAction.ACTION_DR_INVESTIGATOR_REPORT);
        report.setViewAction(RBACAction.ACTION_DR_VIEW_MGMT_REPORT);
    ...
    public static IReport piGlasgowMgmtReport(DataSet ds) throws ReportException {
        ...
        IManagementReport report = factory.createManagementReport(ds, "EDIE Test - Principal Investigator (North London Hub) Report");
        report.setEmailAction(RBACAction.ACTION_DR_INVESTIGATOR_REPORT);
        report.setViewAction(RBACAction.ACTION_DR_VIEW_MGMT_REPORT);
	...
	public static IReport ukCRNReport(DataSet ds) throws ReportException {
		...
		IManagementReport report = factory.createManagementReport(ds, "EDIE 2 Test - UKCRN Report");
		...
		IUKCRNSummaryChart chart = factory.createUKCRNSummaryChart(org.psygrid.data.reporting.Chart.CHART_TABLE, "Test EDIE");
	...
	public static IReport cpmRecruitmentReport(DataSet ds) throws ReportException {
		...
		IManagementReport report = factory.createManagementReport(ds, "EDIE 2 Test - Recruitment Progress Report");
	...
	private static IManagementReport recruitmentReport(DataSet ds, List<Group> groups, String hub, String role) throws ReportException {
		 ...
		 */
		IRecruitmentProgressChart chart = factory.createRecruitmentProgressChart(Chart.CHART_TIME_SERIES, "EDIE 2 Test - Recruitment Progress ("+hub+")");
	...
	public static IReport ciReceivingTreatmentReport(DataSet ds) throws ReportException {
		IManagementReport report = receivingTreatmentReport(ds, null, "", "Chief Investigator");
		report.setEmailAction(RBACAction.ACTION_DR_CHIEF_INVESTIGATOR_REPORT);
		report.setViewAction(RBACAction.ACTION_DR_VIEW_MGMT_REPORT);
		report.setTemplate(true);
		return report;
	...
	public static IReport cpmReceivingTreatmentReport(DataSet ds) throws ReportException {
		...
		IManagementReport report = factory.createManagementReport(ds, "EDIE 2 Test - CPM Receiving Treatment Report");
		report.setEmailAction(RBACAction.ACTION_DR_CRM_REPORT);
		report.setViewAction(RBACAction.ACTION_DR_VIEW_MGMT_REPORT);
		report.setTemplate(true);
	...
	private static IManagementReport receivingTreatmentReport(DataSet ds, List<Group> groups, String hub, String role) throws ReportException {
		...
		IManagementReport report = factory.createManagementReport(ds, "EDIE 2 Test - Receiving Treatment Report");
		//report.setRole(role);
		report.setWithRawData(true);
		 ...
		 */
		IReceivingTreatmentChart chart = factory.createReceivingTreatmentChart(Chart.CHART_TABLE, "EDIE 2 Test - ("+hub+")");
	...
	private static IManagementReport recordStatusReport(DataSet ds, List<Group> groups, String hub, String role) throws ReportException {
		...
		IManagementReport report = factory.createManagementReport(ds, "Edie Test - Record Status Report");
		//report.setRole(role);
		report.setWithRawData(true);
		report.setTemplate(true);
		 ...
		 */
		IRecordStatusChart chart = factory.createRecordStatusChart(Chart.CHART_TABLE, hub);
	...
	private static IManagementReport documentStatusReport(DataSet ds, List<Group> groups, String hub, String role) throws ReportException {
		...
		IManagementReport report = factory.createManagementReport(ds, "Edie Test - Document Status Report");
		//report.setRole(role);
		report.setWithRawData(true);
		report.setTemplate(true);
		report.setFrequency(ReportFrequency.NEVER);
		 ...
		 * Create a tabular chart showing the records in the groups provided and their current status
		 */
		IDocumentStatusChart chart = factory.createDocumentStatusChart(Chart.CHART_TABLE, hub);
	...
	public static IReport collectionDateReport(DataSet ds, List<Group> groups, String hub) throws ReportException {
		...
		IManagementReport report = factory.createManagementReport(ds, "Edie Test - Document Collection Date Report");
		report.setEmailAction(RBACAction.ACTION_DR_INVESTIGATOR_REPORT);
		report.setViewAction(RBACAction.ACTION_DR_VIEW_MGMT_REPORT);
		report.setWithRawData(true);
		report.setTemplate(true);
	...
	public static IReport stdCodeStatusReport(DataSet ds) throws ReportException {
		...
		IManagementReport report = factory.createManagementReport(ds, "Edie Test - Standard Codes Usage Report");
		report.setEmailAction(RBACAction.ACTION_DR_INVESTIGATOR_REPORT);
		report.setViewAction(RBACAction.ACTION_DR_VIEW_MGMT_REPORT);
		report.setWithRawData(true);
		report.setTemplate(true);
