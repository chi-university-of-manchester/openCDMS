...
public class InstallEDIETestRandomizer {
	...
	private static Log _log = LogFactory.getLog(InstallEDIETestRandomizer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        try{
            ...
            StratifiedRandomizer rnd = new StratifiedRandomizer("EDT");
            ...
            rnd.addTreatment("EDIE Test Control","EDT-000");
            rnd.addTreatment("EDIE Test Cognitive Behaviour Therapy","EDT-001");
