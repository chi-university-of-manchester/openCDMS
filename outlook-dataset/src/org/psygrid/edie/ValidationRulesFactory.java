...
public class ValidationRulesFactory implements IValidationRuleFactory {
	...
	private class ValidationRules extends org.psygrid.common.ValidationRules {
		...
		public void init(Factory factory, DataSet dataSet) {
	        ...
	        //numeric validation rule for Calgary Depression Scale
	        NumericValidationRule calgaryRule = factory.createNumericValidationRule();
	        calgaryRule.setDescription("Calgary validation rule");
	        calgaryRule.setLowerLimit(0.0);
	        calgaryRule.setUpperLimit(3.0);
	        rulesMap.put("Calgary validation rule",calgaryRule);
	        ...
	        //Level of Distresss validation rule
	        NumericValidationRule levelOfDistressRule = factory.createNumericValidationRule();
	        levelOfDistressRule.setDescription("Level of distress validation rule");
	        levelOfDistressRule.setLowerLimit(0.0);
	        levelOfDistressRule.setUpperLimit(100.0);
	        rulesMap.put("Level of distress validation rule",levelOfDistressRule);
	        ...
	        NumericValidationRule zeroToTwentyFour = factory.createNumericValidationRule();
	        zeroToTwentyFour.setDescription("ZeroToTwentyFour");
	        zeroToTwentyFour.setLowerLimit(0.0);
	        zeroToTwentyFour.setUpperLimit(24.0);
	        rulesMap.put("ZeroToTwentyFour",zeroToTwentyFour);

	        NumericValidationRule zeroTo168 = factory.createNumericValidationRule();
	        zeroTo168.setDescription("ZeroTo168");
	        zeroTo168.setLowerLimit(0.0);
	        zeroTo168.setUpperLimit(168.0);
	        rulesMap.put("ZeroTo168",zeroTo168);
