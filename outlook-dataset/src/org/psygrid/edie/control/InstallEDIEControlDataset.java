...
public class InstallEDIEControlDataset {
	...
	private static Log _log = LogFactory.getLog(InstallEDIEControlDataset.class);
	...
	public static void main(String[] args) throws Exception {
		...
		SAMLAssertion sa = qc.getSAMLAssertion(new ProjectType("EDIE Contol", "EDC", "EDIE Control", "0", false));
		EDIEControlDataset od = new EDIEControlDataset();
