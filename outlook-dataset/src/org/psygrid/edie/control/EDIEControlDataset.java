...
public class EDIEControlDataset {
	...
	public void delete(long id, String saml, String repository){
		try{
			...
			client.removePublishedDataSet(id, "EDC", saml);
	...
	public static DataSet createDataset(){
		...
		DataSet dataSet = factory.createDataset("EDIE Control", "EDIE Control");
		...
		//document groups
		DocumentGroup baselineGroup = factory.createDocumentGroup("Baseline Group");
		baselineGroup.setDisplayText("Baseline");
		baselineGroup.setAllowedRecordStatus(getStatuses(dataSet, GenericState.ACTIVE));
		// baselineMinus1.addAllowedRecordStatus(statReferred);
		baselineGroup.setUpdateStatus(statActive);

//		IDocumentGroup baseline0 = factory.createDocumentGroup("Baseline 0 Group");
...
//		IDocumentGroup oneMonth = factory.createDocumentGroup("1 month Group");
...
//		IDocumentGroup twoMonths = factory.createDocumentGroup("2 months Group");
...
//		IDocumentGroup threeMonths = factory.createDocumentGroup("3 months Group");
...
//		IDocumentGroup fourMonths = factory.createDocumentGroup("4 months Group");
...
//		IDocumentGroup fiveMonths = factory.createDocumentGroup("5 months Group");
...
//		IDocumentGroup sixMonths = factory.createDocumentGroup("6 months Group");
...
//		IDocumentGroup nineMonths = factory.createDocumentGroup("9 months Group");
...
//		IDocumentGroup twelveMonths = factory.createDocumentGroup("12 months");
...
//		IDocumentGroup fifteenMonths = factory.createDocumentGroup("15 months Group");
...
//		IDocumentGroup eighteenMonths = factory.createDocumentGroup("18 months Group");
...
//		IDocumentGroup twentyOneMonths = factory.createDocumentGroup("21 months Group");
...
//		IDocumentGroup twentyFourMonths = factory.createDocumentGroup("24 months Group");
...
//		IDocumentGroup studyTermination = factory.createDocumentGroup("Study termination");
...
//		IDocumentGroup transition = factory.createDocumentGroup("Transition");
...
//		transition.setAllowedRecordStatus(getStatuses(dataSet, GenericState.ACTIVE));
		...
		dataSet.addDocumentGroup(baselineGroup);
...
//		dataSet.addDocumentGroup(transition);
		...
		DocumentOccurrence demogsbm1 = factory.createDocumentOccurrence("Baseline");
		demogsbm1.setDisplayText("Baseline");
		demogs.addOccurrence(demogsbm1);
		demogsbm1.setDocumentGroup(baselineGroup);
		...
		DocumentOccurrence caarmsbm1 = factory.createDocumentOccurrence("Baseline");
		caarmsbm1.setDisplayText("Baseline");
		caarmsWithGAF.addOccurrence(caarmsbm1);
		caarmsbm1.setDocumentGroup(baselineGroup);

		Document bdi7 = BDI7.createDocument(factory);
		dataSet.addDocument(bdi7);
		bdi7.addConsentFormGroup(cfg);
		DocumentOccurrence bdi7bm1 = factory.createDocumentOccurrence("Baseline");
		bdi7bm1.setDisplayText("Baseline");
		bdi7.addOccurrence(bdi7bm1);
		bdi7bm1.setDocumentGroup(baselineGroup);

		Document sias = SIAS.createDocument(factory);
		dataSet.addDocument(sias);
		sias.addConsentFormGroup(cfg);
		DocumentOccurrence siasbm1 = factory.createDocumentOccurrence("Baseline");
		siasbm1.setDisplayText("Baseline");
		sias.addOccurrence(siasbm1);
		siasbm1.setDocumentGroup(baselineGroup);

		Document eq5d = EQ5D.createDocument(factory);
		dataSet.addDocument(eq5d);
		eq5d.addConsentFormGroup(cfg);
		DocumentOccurrence eq5dbm1 = factory.createDocumentOccurrence("Baseline");
		eq5dbm1.setDisplayText("Baseline");
		eq5d.addOccurrence(eq5dbm1);
		eq5dbm1.setDocumentGroup(baselineGroup);

		Document pbiq = PersonalBeliefsAboutIllness.createDocument(factory);
		dataSet.addDocument(pbiq);
		pbiq.addConsentFormGroup(cfg);
		DocumentOccurrence pbiqbm1 = factory.createDocumentOccurrence("Baseline");
		pbiqbm1.setDisplayText("Baseline");
		pbiq.addOccurrence(pbiqbm1);
		pbiqbm1.setDocumentGroup(baselineGroup);

		Document mansa = MANSA.createDocument(factory);
		dataSet.addDocument(mansa);
		mansa.addConsentFormGroup(cfg);
		DocumentOccurrence mansabm1 = factory.createDocumentOccurrence("Baseline");
		mansabm1.setDisplayText("Baseline");
		mansa.addOccurrence(mansabm1);
		mansabm1.setDocumentGroup(baselineGroup);

		Document drugCheck = DrugCheck.createDocument(factory);
		dataSet.addDocument(drugCheck);
		drugCheck.addConsentFormGroup(cfg);
		DocumentOccurrence drugCheckbm1 = factory.createDocumentOccurrence("Baseline");
		drugCheckbm1.setDisplayText("Baseline");
		drugCheck.addOccurrence(drugCheckbm1);
		drugCheckbm1.setDocumentGroup(baselineGroup);


		Document epq = EPQv3Short.createDocument(factory);
		dataSet.addDocument(epq);
		epq.addConsentFormGroup(cfg);
		DocumentOccurrence epqbm1 = factory.createDocumentOccurrence("Baseline");
		epqbm1.setDisplayText("Baseline");
		epq.addOccurrence(epqbm1);
		epqbm1.setDocumentGroup(baselineGroup);


		Document baps = BAPS.createDocument(factory);
		dataSet.addDocument(baps);
		baps.addConsentFormGroup(cfg);
		DocumentOccurrence bapsm1 = factory.createDocumentOccurrence("Baseline");
		bapsm1.setDisplayText("Baseline");
		baps.addOccurrence(bapsm1);
		bapsm1.setDocumentGroup(baselineGroup);


		Document ivi = IVI.createDocument(factory);
		dataSet.addDocument(ivi);
		ivi.addConsentFormGroup(cfg);
		DocumentOccurrence ivim1 = factory.createDocumentOccurrence("Baseline");
		ivim1.setDisplayText("Baseline");
		ivi.addOccurrence(ivim1);
		ivim1.setDocumentGroup(baselineGroup);


		Document mcg30 = MCQ30.createDocument(factory);
		dataSet.addDocument(mcg30);
		mcg30.addConsentFormGroup(cfg);
		DocumentOccurrence mcg30m1 = factory.createDocumentOccurrence("Baseline");
		mcg30m1.setDisplayText("Baseline");
		mcg30.addOccurrence(mcg30m1);
		mcg30m1.setDocumentGroup(baselineGroup);


		Document bccs = BriefCoreSchemaScales.createDocument(factory);
		dataSet.addDocument(bccs);
		bccs.addConsentFormGroup(cfg);
		DocumentOccurrence bccsm1 = factory.createDocumentOccurrence("Baseline");
		bccsm1.setDisplayText("Baseline");
		bccs.addOccurrence(bccsm1);
		bccsm1.setDocumentGroup(baselineGroup);


		Document pads10 = PADS10.createDocument(factory);
		dataSet.addDocument(pads10);
		pads10.addConsentFormGroup(cfg);
		DocumentOccurrence pads10m1 = factory.createDocumentOccurrence("Baseline");
		pads10m1.setDisplayText("Baseline");
		pads10.addOccurrence(pads10m1);
		pads10m1.setDocumentGroup(baselineGroup);


		// Baseline 0
//		IDocumentOccurrence caarmsb0 = factory.createDocumentOccurrence("Baseline 0");
...
//		createBaselineReminders(caarmsb0, factory);

//		IDocument scid = SCID.createDocument(factory);
//		dataSet.addDocument(scid);
//		scid.addConsentFormGroup(cfg);
//		IDocumentOccurrence scidb0 = factory.createDocumentOccurrence("Baseline 0");
//		scidb0.setDisplayText("Baseline 0");
//		scid.addOccurrence(scidb0);
//		scidb0.setDocumentGroup(baseline0);
//		createBaselineReminders(scidb0, factory);

//		IDocumentOccurrence treatmentb0 = factory.createDocumentOccurrence("Baseline 0");
//		treatmentb0.setDisplayText("Baseline 0");
//		treatment.addOccurrence(treatmentb0);
//		treatmentb0.setDocumentGroup(baseline0);
//		createBaselineReminders(treatmentb0, factory);

//		// Month 1
//		IDocumentOccurrence caarmsm1 = factory.createDocumentOccurrence("1 Month");
...
//		IDocumentOccurrence bdi7m1 = factory.createDocumentOccurrence("1 Month");
...
//		IDocumentOccurrence eq5dm1 = factory.createDocumentOccurrence("1 Month");
...
//		IDocumentOccurrence siasm1 = factory.createDocumentOccurrence("1 Month");
...
//		IDocumentOccurrence treatmentm1 = factory.createDocumentOccurrence("1 Month");
...
//		// Month 2
//		IDocumentOccurrence caarmsm2 = factory.createDocumentOccurrence("2 Months");
...
//		IDocumentOccurrence bdi7m2 = factory.createDocumentOccurrence("2 Months");
...
//		IDocumentOccurrence eq5dm2 = factory.createDocumentOccurrence("2 Months");
...
//		IDocumentOccurrence siasm2 = factory.createDocumentOccurrence("2 Months");
...
//		IDocumentOccurrence treatmentm2 = factory.createDocumentOccurrence("2 Months");
...
//		// Month 3
//		IDocumentOccurrence caarmsm3 = factory.createDocumentOccurrence("3 Months");
...
//		IDocumentOccurrence bdi7m3 = factory.createDocumentOccurrence("3 Months");
...
//		IDocumentOccurrence eq5dm3 = factory.createDocumentOccurrence("3 Months");
...
//		IDocumentOccurrence siasm3 = factory.createDocumentOccurrence("3 Months");
...
//		IDocumentOccurrence treatmentm3 = factory.createDocumentOccurrence("3 Months");
...
//		IDocumentOccurrence nphrm3 = factory.createDocumentOccurrence("3 Months");
...
//		IDocumentOccurrence phrm3 = factory.createDocumentOccurrence("3 Months");
...
//		IDocumentOccurrence epqm3 = factory.createDocumentOccurrence("3 Months");
...
//		// Month 4
//		IDocumentOccurrence caarmsm4 = factory.createDocumentOccurrence("4 Months");
...
//		IDocumentOccurrence bdi7m4 = factory.createDocumentOccurrence("4 Months");
...
//		IDocumentOccurrence eq5dm4 = factory.createDocumentOccurrence("4 Months");
...
//		IDocumentOccurrence siasm4 = factory.createDocumentOccurrence("4 Months");
...
//		IDocumentOccurrence treatmentm4 = factory.createDocumentOccurrence("4 Months");
...
//		// Month 5
//		IDocumentOccurrence caarmsm5 = factory.createDocumentOccurrence("5 Months");
...
//		IDocumentOccurrence bdi7m5 = factory.createDocumentOccurrence("5 Months");
...
//		IDocumentOccurrence eq5dm5 = factory.createDocumentOccurrence("5 Months");
...
//		IDocumentOccurrence siasm5 = factory.createDocumentOccurrence("5 Months");
...
//		IDocumentOccurrence treatmentm5 = factory.createDocumentOccurrence("5 Months");
...
//		// Month 6
//		IDocumentOccurrence caarmsm6 = factory.createDocumentOccurrence("6 Months");
...
//		IDocumentOccurrence bdi7m6 = factory.createDocumentOccurrence("6 Months");
...
//		IDocumentOccurrence eq5dm6 = factory.createDocumentOccurrence("6 Months");
...
//		IDocumentOccurrence siasm6 = factory.createDocumentOccurrence("6 Months");
...
//		IDocumentOccurrence pbiqm6 = factory.createDocumentOccurrence("6 Months");
...
//		IDocumentOccurrence drugCheckm6 = factory.createDocumentOccurrence("6 Months");
...
//		IDocumentOccurrence mansam6 = factory.createDocumentOccurrence("6 Months");
...
//		IDocumentOccurrence treatmentm6 = factory.createDocumentOccurrence("6 Months");
...
//		IDocumentOccurrence nphrm6 = factory.createDocumentOccurrence("6 Months");
...
//		IDocumentOccurrence phrm6 = factory.createDocumentOccurrence("6 Months");
...
//		IDocumentOccurrence epqm6 = factory.createDocumentOccurrence("6 Months");
...
//		// Month 9
//		IDocumentOccurrence caarmsm9 = factory.createDocumentOccurrence("9 Months");
...
//		IDocumentOccurrence bdi7m9 = factory.createDocumentOccurrence("9 Months");
...
//		IDocumentOccurrence eq5dm9 = factory.createDocumentOccurrence("9 Months");
...
//		IDocumentOccurrence siasm9 = factory.createDocumentOccurrence("9 Months");
...
//		IDocumentOccurrence treatmentm9 = factory.createDocumentOccurrence("9 Months");
...
//		IDocumentOccurrence nphrm9 = factory.createDocumentOccurrence("9 Months");
...
//		IDocumentOccurrence phrm9 = factory.createDocumentOccurrence("9 Months");
...
//		IDocumentOccurrence epqm9 = factory.createDocumentOccurrence("9 Months");
...
//		// Month 12
//		IDocumentOccurrence caarmsm12 = factory.createDocumentOccurrence("12 Months");
...
//		IDocumentOccurrence bdi7m12 = factory.createDocumentOccurrence("12 Months");
...
//		IDocumentOccurrence eq5dm12 = factory.createDocumentOccurrence("12 Months");
...
//		IDocumentOccurrence siasm12 = factory.createDocumentOccurrence("12 Months");
...
//		IDocumentOccurrence pbiqm12 = factory.createDocumentOccurrence("12 Months");
...
//		IDocumentOccurrence drugCheckm12 = factory.createDocumentOccurrence("12 Months");
...
//		IDocumentOccurrence mansam12 = factory.createDocumentOccurrence("12 Months");
...
//		IDocumentOccurrence treatmentm12 = factory.createDocumentOccurrence("12 Months");
...
//		IDocumentOccurrence nphrm12 = factory.createDocumentOccurrence("12 Months");
...
//		IDocumentOccurrence phrm12 = factory.createDocumentOccurrence("12 Months");
...
//		IDocumentOccurrence epqm12 = factory.createDocumentOccurrence("12 Months");
...
//		// Month 15
//		IDocumentOccurrence caarmsm15 = factory.createDocumentOccurrence("15 Months");
...
//		IDocumentOccurrence bdi7m15 = factory.createDocumentOccurrence("15 Months");
...
//		IDocumentOccurrence eq5dm15 = factory.createDocumentOccurrence("15 Months");
...
//		IDocumentOccurrence siasm15 = factory.createDocumentOccurrence("15 Months");
...
//		IDocumentOccurrence treatmentm15 = factory.createDocumentOccurrence("15 Months");
...
//		IDocumentOccurrence nphrm15 = factory.createDocumentOccurrence("15 Months");
...
//		IDocumentOccurrence phrm15 = factory.createDocumentOccurrence("15 Months");
...
//		IDocumentOccurrence epqm15 = factory.createDocumentOccurrence("15 Months");
...
//		// Month 18
//		IDocumentOccurrence caarmsm18 = factory.createDocumentOccurrence("18 Months");
...
//		IDocumentOccurrence bdi7m18 = factory.createDocumentOccurrence("18 Months");
...
//		IDocumentOccurrence eq5dm18 = factory.createDocumentOccurrence("18 Months");
...
//		IDocumentOccurrence siasm18 = factory.createDocumentOccurrence("18 Months");
...
//		IDocumentOccurrence pbiqm18 = factory.createDocumentOccurrence("18 Months");
...
//		IDocumentOccurrence drugCheckm18 = factory.createDocumentOccurrence("18 Months");
...
//		IDocumentOccurrence mansam18 = factory.createDocumentOccurrence("18 Months");
...
//		IDocumentOccurrence treatmentm18 = factory.createDocumentOccurrence("18 Months");
...
//		IDocumentOccurrence nphrm18 = factory.createDocumentOccurrence("18 Months");
...
//		IDocumentOccurrence phrm18 = factory.createDocumentOccurrence("18 Months");
...
//		IDocumentOccurrence epqm18 = factory.createDocumentOccurrence("18 Months");
...
//		// Month 21
//		IDocumentOccurrence caarmsm21 = factory.createDocumentOccurrence("21 Months");
...
//		IDocumentOccurrence bdi7m21 = factory.createDocumentOccurrence("21 Months");
...
//		IDocumentOccurrence eq5dm21 = factory.createDocumentOccurrence("21 Months");
...
//		IDocumentOccurrence siasm21 = factory.createDocumentOccurrence("21 Months");
...
//		IDocumentOccurrence treatmentm21 = factory.createDocumentOccurrence("21 Months");
...
//		IDocumentOccurrence nphrm21 = factory.createDocumentOccurrence("21 Months");
...
//		IDocumentOccurrence phrm21 = factory.createDocumentOccurrence("21 Months");
...
//		IDocumentOccurrence epqm21 = factory.createDocumentOccurrence("21 Months");
...
//		// Month 24
//		IDocumentOccurrence caarmsm24 = factory.createDocumentOccurrence("24 Months");
...
//		IDocumentOccurrence bdi7m24 = factory.createDocumentOccurrence("24 Months");
...
//		IDocumentOccurrence eq5dm24 = factory.createDocumentOccurrence("24 Months");
...
//		IDocumentOccurrence siasm24 = factory.createDocumentOccurrence("24 Months");
...
//		IDocumentOccurrence pbiqm24 = factory.createDocumentOccurrence("24 Months");
...
//		IDocumentOccurrence drugCheckm24 = factory.createDocumentOccurrence("24 Months");
...
//		IDocumentOccurrence mansam24 = factory.createDocumentOccurrence("24 Months");
...
//		IDocumentOccurrence treatmentm24 = factory.createDocumentOccurrence("24 Months");
...
//		IDocumentOccurrence nphrm24 = factory.createDocumentOccurrence("24 Months");
...
//		IDocumentOccurrence phrm24 = factory.createDocumentOccurrence("24 Months");
...
//		IDocumentOccurrence epqm24 = factory.createDocumentOccurrence("24 Months");
...
//		// Transition
//		IDocument tranDoc = Transition.createDocument(factory);
//		dataSet.addDocument(tranDoc);
//		tranDoc.addConsentFormGroup(cfg);
//		IDocumentOccurrence tranDocOcc = factory.createDocumentOccurrence("Transition");
//		tranDocOcc.setDisplayText("Transition");
//		tranDoc.addOccurrence(tranDocOcc);
//		tranDocOcc.setDocumentGroup(transition);

//		IDocumentOccurrence caarmsTransition = factory.createDocumentOccurrence("Transition");
...
//		IDocumentOccurrence mansaTransition = factory.createDocumentOccurrence("Transition");
//		mansaTransition.setDisplayText("Transition");
//		mansa.addOccurrence(mansaTransition);
//		mansaTransition.setDocumentGroup(transition);

//		IDocumentOccurrence treatmentTransition = factory.createDocumentOccurrence("Transition");
...
//		// Termination
//		IDocument termDoc = StudyTermination.createDocument(factory);
//		dataSet.addDocument(termDoc);
//		termDoc.addConsentFormGroup(cfg);
//		IDocumentOccurrence termDocOcc = factory.createDocumentOccurrence("Termination");
//		termDocOcc.setDisplayText("Termination");
//		termDoc.addOccurrence(termDocOcc);
//		termDocOcc.setDocumentGroup(studyTermination);

//		IDocumentOccurrence scidTermination = factory.createDocumentOccurrence("Termination");
...
//		scidTermination.setDocumentGroup(studyTermination);
		...
		//===============================================
		//Additional forms added after initial deployment
		//===============================================

		//Current Treatment - Baseline -1
//		IDocument currentTreatment = CurrentTreatment.createDocument(factory);
//		dataSet.addDocument(currentTreatment);
//		currentTreatment.addConsentFormGroup(cfg);
//		IDocumentOccurrence ctbm1 = factory.createDocumentOccurrence("Baseline -1");
//		ctbm1.setDisplayText("Baseline -1");
//		currentTreatment.addOccurrence(ctbm1);
//		ctbm1.setDocumentGroup(baselineMinus1);

//		IDocument baps = BAPS.createDocument(factory);
//		dataSet.addDocument(baps);
//		baps.addConsentFormGroup(cfg);
//		IDocumentOccurrence bapsm1 = factory.createDocumentOccurrence("1 Month");
//		bapsm1.setDisplayText("1 Month");
//		baps.addOccurrence(bapsm1);
//		bapsm1.setDocumentGroup(oneMonth);
//		IDocumentOccurrence bapsm6 = factory.createDocumentOccurrence("6 Months");
//		bapsm6.setDisplayText("6 Months");
//		baps.addOccurrence(bapsm6);
//		bapsm6.setDocumentGroup(sixMonths);

//		IDocument ivi = IVI.createDocument(factory);
//		dataSet.addDocument(ivi);
//		ivi.addConsentFormGroup(cfg);
//		IDocumentOccurrence ivim1 = factory.createDocumentOccurrence("1 Month");
//		ivim1.setDisplayText("1 Month");
//		ivi.addOccurrence(ivim1);
//		ivim1.setDocumentGroup(oneMonth);
//		IDocumentOccurrence ivim6 = factory.createDocumentOccurrence("6 Months");
//		ivim6.setDisplayText("6 Months");
//		ivi.addOccurrence(ivim6);
//		ivim6.setDocumentGroup(sixMonths);

//		IDocument mcg30 = MCQ30.createDocument(factory);
//		dataSet.addDocument(mcg30);
//		mcg30.addConsentFormGroup(cfg);
//		IDocumentOccurrence mcg30m1 = factory.createDocumentOccurrence("1 Month");
//		mcg30m1.setDisplayText("1 Month");
//		mcg30.addOccurrence(mcg30m1);
//		mcg30m1.setDocumentGroup(oneMonth);
//		IDocumentOccurrence mcg30m6 = factory.createDocumentOccurrence("6 Months");
//		mcg30m6.setDisplayText("6 Months");
//		mcg30.addOccurrence(mcg30m6);
//		mcg30m6.setDocumentGroup(sixMonths);

//		IDocument bccs = BriefCoreSchemaScales.createDocument(factory);
//		dataSet.addDocument(bccs);
//		bccs.addConsentFormGroup(cfg);
//		IDocumentOccurrence bccsm1 = factory.createDocumentOccurrence("1 Month");
//		bccsm1.setDisplayText("1 Month");
//		bccs.addOccurrence(bccsm1);
//		bccsm1.setDocumentGroup(oneMonth);
//		IDocumentOccurrence bccsm6 = factory.createDocumentOccurrence("6 Months");
//		bccsm6.setDisplayText("6 Months");
//		bccs.addOccurrence(bccsm6);
//		bccsm6.setDocumentGroup(sixMonths);

//		IDocument pads10 = PADS10.createDocument(factory);
//		dataSet.addDocument(pads10);
//		pads10.addConsentFormGroup(cfg);
//		IDocumentOccurrence pads10m1 = factory.createDocumentOccurrence("1 Month");
//		pads10m1.setDisplayText("1 Month");
//		pads10.addOccurrence(pads10m1);
//		pads10m1.setDocumentGroup(oneMonth);
//		IDocumentOccurrence pads10m6 = factory.createDocumentOccurrence("6 Months");
//		pads10m6.setDisplayText("6 Months");
//		pads10.addOccurrence(pads10m6);
//		pads10m6.setDocumentGroup(sixMonths);
	...
	public static void createReports(DataSet ds, String saml) throws Exception {
		...
		IReport receivingTreatmentInManchester = Reports.receivingTreatmentInManchesterReport(ds);
		...
		client.saveReport(receivingTreatmentInManchester, saml);
...
//	private static void createBaselineReminders(IDocumentOccurrence occurrence, Factory factory){
//	occurrence.setScheduleTime(new Integer(30));
//	occurrence.setScheduleUnits(TimeUnits.DAYS);
//	}
//	private static void createOneMonthReminders(IDocumentOccurrence occurrence, Factory factory){
//	occurrence.setScheduleTime(new Integer(61));
//	occurrence.setScheduleUnits(TimeUnits.DAYS);
//	}
//	private static void createTwoMonthReminders(IDocumentOccurrence occurrence, Factory factory){
//	occurrence.setScheduleTime(new Integer(91));
//	occurrence.setScheduleUnits(TimeUnits.DAYS);
//	}
//	private static void createThreeMonthReminders(IDocumentOccurrence occurrence, Factory factory){
//	occurrence.setScheduleTime(new Integer(122));
//	occurrence.setScheduleUnits(TimeUnits.DAYS);
//	}
//	private static void createFourMonthReminders(IDocumentOccurrence occurrence, Factory factory){
//	occurrence.setScheduleTime(new Integer(152));
//	occurrence.setScheduleUnits(TimeUnits.DAYS);
//	}
//	private static void createFiveMonthReminders(IDocumentOccurrence occurrence, Factory factory){
//	occurrence.setScheduleTime(new Integer(183));
//	occurrence.setScheduleUnits(TimeUnits.DAYS);
//	}

//	private static void createSixMonthReminders(IDocumentOccurrence occurrence, Factory factory){
//	occurrence.setScheduleTime(new Integer(213));
//	occurrence.setScheduleUnits(TimeUnits.DAYS);
//	}

//	private static void createNineMonthReminders(IDocumentOccurrence occurrence, Factory factory){
//	occurrence.setScheduleTime(new Integer(305));
//	occurrence.setScheduleUnits(TimeUnits.DAYS);
//	}

//	private static void createTwelveMonthReminders(IDocumentOccurrence occurrence, Factory factory){
//	occurrence.setScheduleTime(new Integer(397));
//	occurrence.setScheduleUnits(TimeUnits.DAYS);
//	}
//	private static void createFifteenMonthReminders(IDocumentOccurrence occurrence, Factory factory){
//	occurrence.setScheduleTime(new Integer(489));
//	occurrence.setScheduleUnits(TimeUnits.DAYS);
//	}
//	private static void createEighteenMonthReminders(IDocumentOccurrence occurrence, Factory factory){
//	occurrence.setScheduleTime(new Integer(580));
//	occurrence.setScheduleUnits(TimeUnits.DAYS);
//	}
//	private static void createTwentyOneMonthReminders(IDocumentOccurrence occurrence, Factory factory){
//	occurrence.setScheduleTime(new Integer(671));
//	occurrence.setScheduleUnits(TimeUnits.DAYS);
//	}
//	private static void createTwentyFourMonthReminders(IDocumentOccurrence occurrence, Factory factory){
