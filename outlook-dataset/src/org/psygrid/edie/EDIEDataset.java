...
public class EDIEDataset {
	...
	public static DataSet createDataset(){
		...
		DataSet dataSet = factory.createDataset("EDIE 2", "EDIE 2");
		...
		//Don't automatically set records to complete, to allow the study termination stage to be entered.
		//The study termination stage is done for different reasons so has no update status set.
		...
		studyTermination.setAllowedRecordStatus(EDIEDataset.getStatuses(dataSet, GenericState.ACTIVE));
		...
		Document currentTreatment = CurrentTreatment.createDocument(factory);
		dataSet.addDocument(currentTreatment);
		currentTreatment.addConsentFormGroup(cfg);
		DocumentOccurrence ctbm1 = factory.createDocumentOccurrence("Baseline -1");
		...
		DocumentOccurrence bapsm1 = factory.createDocumentOccurrence("1 Month");
		bapsm1.setDisplayText("1 Month");
		baps.addOccurrence(bapsm1);
		bapsm1.setDocumentGroup(oneMonth);
		DocumentOccurrence bapsm6 = factory.createDocumentOccurrence("6 Months");
		...
		DocumentOccurrence ivim1 = factory.createDocumentOccurrence("1 Month");
		ivim1.setDisplayText("1 Month");
		ivi.addOccurrence(ivim1);
		ivim1.setDocumentGroup(oneMonth);
		DocumentOccurrence ivim6 = factory.createDocumentOccurrence("6 Months");
		...
		DocumentOccurrence mcg30m1 = factory.createDocumentOccurrence("1 Month");
		mcg30m1.setDisplayText("1 Month");
		mcg30.addOccurrence(mcg30m1);
		mcg30m1.setDocumentGroup(oneMonth);
		DocumentOccurrence mcg30m6 = factory.createDocumentOccurrence("6 Months");
		...
		DocumentOccurrence bccsm1 = factory.createDocumentOccurrence("1 Month");
		bccsm1.setDisplayText("1 Month");
		bccs.addOccurrence(bccsm1);
		bccsm1.setDocumentGroup(oneMonth);
		DocumentOccurrence bccsm6 = factory.createDocumentOccurrence("6 Months");
		...
		DocumentOccurrence pads10m1 = factory.createDocumentOccurrence("1 Month");
		pads10m1.setDisplayText("1 Month");
		pads10.addOccurrence(pads10m1);
		pads10m1.setDocumentGroup(oneMonth);
		DocumentOccurrence pads10m6 = factory.createDocumentOccurrence("6 Months");
	...
	private static void createBaselineReminders(DocumentOccurrence occurrence, Factory factory){
