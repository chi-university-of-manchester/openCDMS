...
public class Patch10 extends AbstractPatch {
	...
	public String getName() {
		return "Update all reports containing a project management chart";
	}
	...
	public void applyPatch(DataSet ds, String saml) throws Exception {
		...
		titles.add(Reports.piBirminghamMgmtReport(ds).getTitle());
		titles.add(Reports.piCambridgeMgmtReport(ds).getTitle());
		titles.add(Reports.piEastAngliaMgmtReport(ds).getTitle());
		titles.add(Reports.piGlasgowMgmtReport(ds).getTitle());
		titles.add(Reports.piManchesterMgmtReport(ds).getTitle());
