...
package org.psygrid.edie.patches.v1_1_8;
...
public class Patch15 extends AbstractPatch {
	...
	public String getName() {
		return "Patch to add receiving treatment reports.";
	}
	...
	private void createReports(ReportsClient client, DataSet ds, String saml) {
		...
		try {
			...
			client.saveReport(Reports.receivingTreatmentInCambridgeReport(ds), saml);
			client.saveReport(Reports.receivingTreatmentInEastAngliaReport(ds), saml);
			client.saveReport(Reports.receivingTreatmentInEastMidlandsReport(ds), saml);
