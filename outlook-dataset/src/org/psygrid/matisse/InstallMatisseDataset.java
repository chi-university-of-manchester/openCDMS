...
public class InstallMatisseDataset {
	...
	private static Log _log = LogFactory.getLog(InstallMatisseDataset.class);
	...
	public static void main(String[] args) throws Exception {
		...
		SAMLAssertion sa = qc.getSAMLAssertion(new ProjectType("Matisse", "MTS", "Matisse", "2269", false));
		MatisseDataset od = new MatisseDataset();
		System.out.println("insert");
		System.out.println(sa.toString());
		System.out.println(properties.getProperty("org.psygrid.data.client.serviceURL"));
//		od.publish(sa.toString(), properties.getProperty("org.psygrid.data.client.serviceURL"));
		System.out.println("dataset is published");
