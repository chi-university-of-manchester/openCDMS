...
import org.psygrid.matisse.AdultServiceUseSchedule;
import org.psygrid.matisse.BaselineAssessmentSchedule;
import org.psygrid.matisse.BaselineQuestionnaire;
import org.psygrid.matisse.GAF;
import org.psygrid.matisse.GeneralWellBeing;
import org.psygrid.matisse.MoriskyScale;
import org.psygrid.matisse.Panss;
import org.psygrid.matisse.ProcessFactors;
import org.psygrid.matisse.QualityOfLife;
import org.psygrid.matisse.Reports;
import org.psygrid.matisse.SatisfactionWithCare;
import org.psygrid.matisse.SocialFunctioning;
import org.psygrid.matisse.UnitFactory;
import org.psygrid.matisse.ValidationRulesFactory;
import org.psygrid.outlook.TransformersFactory;

public class MatisseTestDataset {
    ...
    public void remove(String saml, String repository)
    {
    	try
    	{
            ...
            client.removePublishedDataSet(172058, "MTST", saml);
    	} catch (Exception ex)
    	{
    		ex.printStackTrace();
    	}
...
//            createReports(ds, saml);
    ...
    public static DataSet createDataset()
    {
        ...
        DataSet dataSet = factory.createDataset("Matisse Test", "Matisse Test");
        ...
        pcf.setQuestion("Has the client provided informed consent?");
