...
import org.psygrid.matisse.MatisseGroups;
...
public class InstallMatisseTestProject {
    public static void main (String[] args) throws Exception {
    	AAManagementClient mc = new AAManagementClient("test.properties");

    	ProjectType project = new ProjectType("Matisse Test", "MTST", "Matisse", "2269", false);
    	...
    	try{
    		RoleType[] roles = new RoleType[]{sa, ci, pa, pm, pi, crm, cro, sro, ta, rm, da};
