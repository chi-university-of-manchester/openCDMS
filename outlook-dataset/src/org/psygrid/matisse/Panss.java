...
public class Panss extends AssessmentForm {
    ...
    public static Document createDocument(Factory factory){
        ...
        NumericEntry conceptualDisorganization = factory.createNumericEntry("Conceptual disorganisation", "Conceptual disorganisation");
...
//        IDerivedEntry compositeIndex = factory.createDerivedEntry("Composite Index", "Composite Index");
...
//        compositeIndex.addVariable("ns", subtotalNegative);
        ...
        NumericEntry anger = factory.createNumericEntry("Anger", "Anger");
        panss.addEntry(anger);
        anger.setSection(generalScale);
        anger.setLabel("S1");
        anger.addValidationRule(panssRule);

        NumericEntry difficultyDelayingGratification = factory.createNumericEntry("Difficulty in delaying gratification", "Difficulty in delaying gratification");
        panss.addEntry(difficultyDelayingGratification);
        difficultyDelayingGratification.setSection(generalScale);
        difficultyDelayingGratification.setLabel("S2");
        difficultyDelayingGratification.addValidationRule(panssRule);

        NumericEntry affectiveLability = factory.createNumericEntry("Affective Lability", "Affective Lability");
        panss.addEntry(affectiveLability);
        affectiveLability.setSection(generalScale);
        affectiveLability.setLabel("S3");
        affectiveLability.addValidationRule(panssRule);
        ...
        subtotalGeneral.setDescription("sum of G1 through S3");
        subtotalGeneral.setFormula("sc+a+gf+t+mp+de+mr+u+utc+di+pa+lj+dv+pic+p+asa+ang+dif+lab");
        ...
        subtotalGeneral.addVariable("ang", anger);
        subtotalGeneral.addVariable("dif", difficultyDelayingGratification);
        subtotalGeneral.addVariable("lab", affectiveLability);
