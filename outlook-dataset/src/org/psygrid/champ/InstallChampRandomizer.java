...
public class InstallChampRandomizer {
	...
	private static Log _log = LogFactory.getLog(InstallChampRandomizer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        try{
            ...
            StratifiedRandomizer rnd = new StratifiedRandomizer("CHP");

            Stratum s2 = new Stratum();
            s2.setName("centreNumber");
            s2.getValues().add("001001");
            s2.getValues().add("001002");
            rnd.addStratum(s2);
            Stratum s = new Stratum();
            s.setName("Treatment Stream");
            s.getValues().add("Endocrinology");
            s.getValues().add("Cardiology");
            s.getValues().add("Respiratory");
            s.getValues().add("Medicine & Gastroenterology");
            rnd.addStratum(s);
            rnd.generateCombinations("org.psygrid.randomization.model.hibernate.IBRpbrblRandomizer", 2, 3);
            ...
            rnd.addTreatment("CBT","1");
            rnd.addTreatment("Control","2");
