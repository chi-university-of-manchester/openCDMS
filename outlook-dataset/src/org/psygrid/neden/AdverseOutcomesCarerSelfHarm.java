...
public class AdverseOutcomesCarerSelfHarm extends AssessmentForm{
    ...
    public static Document createDocument(Factory factory) {
        ...
        Document doc = factory.createDocument("Adverse Outcomes Detailed " +
                "Questionnaire (Carer, Self-Harm)", "Adverse Outcomes Detailed Questionnaire (Carer, Self-Harm)");
