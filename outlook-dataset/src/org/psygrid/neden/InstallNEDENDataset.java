...
public class InstallNEDENDataset {
	...
	private static Log _log = LogFactory.getLog(InstallNEDENDataset.class);
	...
	public static void main(String[] args) throws Exception {
		...
		SAMLAssertion sa = qc.getSAMLAssertion(new ProjectType("National EDEN", "NED", "National EDEN", "2158", false));
		NEDENDataset od = new NEDENDataset();
