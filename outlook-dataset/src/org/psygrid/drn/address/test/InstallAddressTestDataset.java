 ...
 *
 */
public class InstallAddressTestDataset {
	...
	private static Log _log = LogFactory.getLog(InstallAddressTestDataset.class);
	...
	public static void main(String[] args) throws Exception {
		...
		SAMLAssertion sa = qc.getSAMLAssertion(new ProjectType("ADDRESS TEST", "ADT", "ADDRESS TEST", "?", false));
		AddressTestDataset od = new AddressTestDataset();
