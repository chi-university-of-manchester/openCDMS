 ...
 *
 */
public class DeleteAddressDataset {
	...
	private static Log _log = LogFactory.getLog(InstallAddressDataset.class);
	...
	public static void main(String[] args) throws Exception {
		...
		DataSet ds = client.getDataSetSummary("ADD", new Date(0), sa.toString());
		client.removePublishedDataSet(ds.getId(), "ADD", sa.toString());

		System.out.println("Dataset ADD removed.");
	}
}
