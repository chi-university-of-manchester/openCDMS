...
public class AddGroupsToAddressEsl3 {
	...
	private static IProject createGroups(IProject project) {
		project.setGroup(factory.createGroup("Royal Blackburn Hospital", "651003"));
		project.setGroup(factory.createGroup("Burnley General Hospital", "651004"));
		return project;
	}
