...
public class AddGroupsToAddressEsl {
	...
	private static IProject createGroups(IProject project) {
		project.setGroup(factory.createGroup("Ealing Hospital", "650003"));
		project.setGroup(factory.createGroup("Imperial College Healthcare NHS trust", "650004"));
		project.setGroup(factory.createGroup("Chelsea and Westminister Hospital ", "650005"));
		project.setGroup(factory.createGroup("West Middlesex University Hospitals", "650006"));
		project.setGroup(factory.createGroup("Barnet and chase farm hospitals", "650007"));
		return project;
	}
