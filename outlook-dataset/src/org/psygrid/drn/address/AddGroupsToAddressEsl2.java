...
public class AddGroupsToAddressEsl2 {
	...
	private static IProject createGroups(IProject project) {
		project.setGroup(factory.createGroup("Central Manchester and Manchester Childrens Hospital", "651002"));
		project.setGroup(factory.createGroup("The Royal Berkshire NHS foundation trust", "649005"));
		project.setGroup(factory.createGroup("Buckinghamshire Hospitals NHS Trust", "649006"));
		project.setGroup(factory.createGroup("Homerton University Hospital NHS Foundation Trust", "653005"));
		project.setGroup(factory.createGroup("Broomfield Hospital", "653006"));
		return project;
	}
