...
public class AddGroupsToAddressEsl10 {
	...
	private static IProject createGroups(IProject project) {
		project.setGroup(factory.createGroup("Durham and Darlington NHS Foundation Trust", "640007"));
		project.setGroup(factory.createGroup("The Queen Elizabeth Hospital King's Lynn", "654006"));
		return project;
	}
