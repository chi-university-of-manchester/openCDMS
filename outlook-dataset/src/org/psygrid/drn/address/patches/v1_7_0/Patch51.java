...
public class Patch51 extends AbstractPatch {
	...
	public String getName() {
		...
		return "Fixing reports after using Create to add groups: Kettering General Hospital and Dartford and Gravesham NHS Trust" ;
	}
