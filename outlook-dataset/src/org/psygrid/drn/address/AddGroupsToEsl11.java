...
public class AddGroupsToEsl11 {
	...
	private static IProject createGroups(IProject project) {
		project.setGroup(factory.createGroup("University Hospitals Coventry", "649004"));
		project.setGroup(factory.createGroup("Barking, Havering and Redbridge Hospitals NHS Trust", "653007"));
		return project;
	}
