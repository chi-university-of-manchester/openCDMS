...
public class EQ5D extends AssessmentForm {
    ...
    public static Document createDocument(Factory factory){
        ...
        NarrativeEntry instructions1 = factory.createNarrativeEntry(
                "Instructions 1",
                "By selecting one option in each group below, please indicate which statements best describe your own health state today.");
        ...
        NarrativeEntry instructions2 = factory.createNarrativeEntry(
                "Instructions 2",
                "Because all replies are anonymous, it will help us to understand your answers better if we have a " +
                        "little background data from everyone, as covered in the following questions.");
        eq5d.addEntry(instructions2);
        instructions2.setSection(mainSec);
        ...
        sex.setLabel("3");
        Option sexMale = factory.createOption("Male");
        Option sexFemale = factory.createOption("Female");
        ...
        Option occ1 = factory.createOption("In employment or self-employment", 6);
