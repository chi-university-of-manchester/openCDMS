...
public class PersonalDetails extends AssessmentForm {
    ...
    public static Document createDocument(Factory factory){
        ...
        doc.addEntry(name);
        name.setSection(mainSec);
        //name.addTransformer(Transformers.getInstance().getTransformer("sha1"));
        ...
        TextEntry postCode = factory.createTextEntry("Postcode area",
				"Postcode area");
        ...
        probableDiagnosis.setDescription("For people with more than one diagnoses please record the most recent ICD-10 diagnosis");
        ...
        CompositeEntry drugUse = factory.createComposite("Past Drug Use", "Past Drug Use");
