 ...
 *
 */
public class InstallCommandTestDataset {
	...
	private static Log _log = LogFactory.getLog(InstallCommandTestDataset.class);
	...
	public static void main(String[] args) throws Exception {
		...
		CommandTestDataset od = new CommandTestDataset();
