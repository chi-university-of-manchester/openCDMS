...
public class InstallCommandTestRandomizer {
	...
	private static Log _log = LogFactory.getLog(InstallCommandTestRandomizer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        try{
            ...
            StratifiedRandomizer rnd = CommandTestRandomizer.createRandomizer();
