 ...
 *
 */
public class DeleteCommandDataset {
	...
	private static Log _log = LogFactory.getLog(DeleteCommandDataset.class);
	...
	public static void main(String[] args) throws Exception {
		...
		DataSet ds = client.getDataSetSummary("COM", new Date(0), sa.toString());
		client.removePublishedDataSet(ds.getId(), "COM", sa.toString());

		System.out.println("Dataset COM removed.");
	}
}
