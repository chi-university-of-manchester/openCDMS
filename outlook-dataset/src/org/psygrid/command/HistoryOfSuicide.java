 ...
 *
 */
public class HistoryOfSuicide extends AssessmentForm {

    public static Document createDocument(Factory factory){

    	Document doc = factory.createDocument("History of Suicide", "History of Suicide, Self harm and Harm to others");
        ...
        OptionEntry q5 = factory.createOptionEntry("Methods", "Methods used to harm/injure self");
        q5.setEntryStatus(EntryStatus.DISABLED);
        q5.setSection(selfHarmSec);
        doc.addEntry(q5);
        createOptions(factory, q5, new String[]{"Overdose", "Poisoning", "Burning", "Scratching/cutting", "Stabbing", "Jumping", "Other"}, new int[]{1,2,3,4,5,6,7});
        Option q5Other = q5.getOption(6);
        ...
        OptionEntry q6 = factory.createOptionEntry("Interntional harm", "Have you intentionally tried to harm or injure others in the past 2 years?");
        ...
        OptionEntry q8 = factory.createOptionEntry("Methods", "Methods used to harm/injure others");
        q8.setEntryStatus(EntryStatus.DISABLED);
        q8.setSection(harmToOthersSec);
        doc.addEntry(q8);
        createOptions(factory, q8, new String[]{"Hitting", "Stabbing", "Shooting", "Strangling", "Poisoning"}, new int[]{1,2,3,4,5});
