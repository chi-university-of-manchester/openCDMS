...
public class InstallOutlookDataset {
	...
	private static Log _log = LogFactory.getLog(InstallOutlookDataset.class);
	...
	public static void main(String[] args) throws Exception {
		...
		SAMLAssertion sa = qc.getSAMLAssertion(new ProjectType("Outlook", "OLK", "PsyGrid", "2146", false));
		OutlookDataset od = new OutlookDataset();
