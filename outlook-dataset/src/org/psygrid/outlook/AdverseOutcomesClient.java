...
public class AdverseOutcomesClient extends AssessmentForm {
    public static Document createDocument(Factory factory) {

        Document doc = factory.createDocument("Adverse Outcomes Screening " +
                "Questionnaire (Client)", "Adverse Outcomes Screening Questionnaire (Client)");
        ...
        OptionEntry thought = factory.createOptionEntry(
                "Thought of harming self",
                "In the last 6 months, have you thought of harming yourself?");
        ...
        OptionEntry harm = factory.createOptionEntry("Harmed self",
                "In the last 6 months, have you harmed yourself?");
        doc.addEntry(harm);
        ...
        CompositeEntry howHarmed = factory.createComposite("How harmed self " +
                "composite", "How did you harm yourself? (record all relevant categories)");
        ...
        OptionEntry thoughtOthers = factory.createOptionEntry(
                "Thought of harming others",
                "In the last 6 months, have you thought of physically " +
                        "harming others?");
        ...
        OptionEntry threatened = factory.createOptionEntry("Threatened with " +
                "violence", "In the last 6 months have you threatened others " +
                "with violence?");
        ...
        OptionEntry harmedOthers = factory.createOptionEntry("Harmed others",
                "In the last 6 months, have you physically harmed others?");
        ...
        OptionEntry pushed = factory.createOptionEntry("Pushed anyone",
                "Have you pushed or grabbed anyone?");
        doc.addEntry(pushed);
        ...
        OptionEntry slapped = factory.createOptionEntry("Slapped anyone",
                "Have you slapped, scratched or bitten anyone?");
        ...
        OptionEntry choked = factory.createOptionEntry("Choked anyone",
                "Have you choked or strangled anyone?");
        doc.addEntry(choked);
        ...
        OptionEntry beaten = factory.createOptionEntry("Beaten anyone",
                "Have you hit anyone with a fist or beaten up anyone?");
        doc.addEntry(beaten);
        ...
        OptionEntry blunt = factory.createOptionEntry("Hit anyone with blunt " +
                "instrument", "Have you hit anyone with a blunt instrument or " +
                "object?");
        doc.addEntry(blunt);
        ...
        OptionEntry knife = factory.createOptionEntry("Used a knife",
                "Have you used a knife or any sharp instrument?");
        doc.addEntry(knife);
        ...
        OptionEntry sex = factory.createOptionEntry("Force anyone to have sex",
                "Have you tried to physically force anyone to have sex against " +
                        "their will?");
        doc.addEntry(sex);
        ...
        OptionEntry otherViolent = factory.createOptionEntry("Anything else " +
                "might be violent",
                "Have you done anything else that might be considered violent? " +
