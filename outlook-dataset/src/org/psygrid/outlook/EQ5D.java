...
public class EQ5D extends AssessmentForm {
    ...
    public static Document createDocument(Factory factory){
        ...
        NumericEntry ageYears = factory.createNumericEntry("Age", "What is your age in years?");
        eq5d.addEntry(ageYears);
        ageYears.setSection(mainSec);
        ageYears.setLabel("2");
        ageYears.addValidationRule(positiveRule);

        OptionEntry sex = factory.createOptionEntry("Sex", "Are you:");
        eq5d.addEntry(sex);
        sex.setSection(mainSec);
        sex.setLabel("3");
        Option sexMale = factory.createOption("Male", 0);
        Option sexFemale = factory.createOption("Female", 1);
        sex.addOption(sexMale);
        sex.addOption(sexFemale);

        OptionEntry smoking = factory.createOptionEntry("Smoking", "Are you:");
        eq5d.addEntry(smoking);
        smoking.setSection(mainSec);
        smoking.setLabel("4");
        Option smokeCurrent = factory.createOption("A current smoker", 0);
        Option smokeEx = factory.createOption("An ex-smoker", 1);
        Option smokeNever = factory.createOption("A never smoker", 2);
        ...
        Option occ1 = factory.createOption("Employed/Self-employed", 0);
        Option occ2 = factory.createOption("Retired", 1);
        Option occ3 = factory.createOption("Housework", 2);
        Option occ4 = factory.createOption("Student", 3);
        Option occ5 = factory.createOption("Seeking work", 4);
        Option occ6 = factory.createOption("Other (please specify)", 5);
