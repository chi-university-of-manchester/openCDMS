 ...
 *
 */
public class TSTGroups extends ProjectGroups {
	...
	public static final GroupType eastMidlands_LincolnshirePartnershipTrust = new GroupType("East Midlands-Lincolnshire Partnership Trust", "003002", project);
