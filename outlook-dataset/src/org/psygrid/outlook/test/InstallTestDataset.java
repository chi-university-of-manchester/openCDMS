...
public class InstallTestDataset {
	...
	private static Log _log = LogFactory.getLog(InstallTestDataset.class);
	...
	public static void main(String[] args) throws Exception {
		...
		SAMLAssertion sa = qc.getSAMLAssertion(new ProjectType("Test", "TST", null, null, false));
		TestDataset od = new TestDataset();
