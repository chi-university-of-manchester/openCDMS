...
package org.psygrid.outlook.test.patches.v1_1_11;
...
public class Patch5 extends AbstractPatch {
	...
	public String getName() {
		return "Add the new Opcrit document to the Outlook Test dataset";
	}
	...
	public void applyPatch(DataSet ds, String saml) throws Exception {
        ...
        DocumentGroup twelveMonths = ds.getDocumentGroup(4);
