    ...
    public void applyPatch(DataSet ds, String saml) throws Exception {
        ...
        for (int i=0; i<numGroups; i++){
        		...
        		if(g.getName().equals("002001")){
        			ArrayList<Site> sl = new ArrayList<Site>();
        			sl.add(new Site("Hellesdon Hospital","N0000696", "NR6 5BE", g));
        			g.setSites(sl);
        		}
        		...
        		if(g.getName().equals("003001")){
        			ArrayList<Site> sl = new ArrayList<Site>();
        			sl.add(new Site("Mapperley Hospital", "N00000689", "NG3 6AA", g));
        			g.setSites(sl);
        		}
        		if(g.getName().equals("003002")){
        			ArrayList<Site> sl = new ArrayList<Site>();
        			sl.add(new Site("Trust HQ, Lincolnshire", "N0000690", "LN4 2HN", g));
        			g.setSites(sl);
        		}
        		if(g.getName().equals("004001")){
        			ArrayList<Site> sl = new ArrayList<Site>();
        			sl.add(new Site("St Nicholas Hospital", "N0000691", "NE3 3XT", g));
        			g.setSites(sl);
        		}
        		if(g.getName().equals("005001")){
        			ArrayList<Site> sl = new ArrayList<Site>();
        			sl.add(new Site("Springfield University Hospital", "N0000687", "SW17 7DJ", g));
        			g.setSites(sl);
        		}
        		if(g.getName().equals("005002")){
        			ArrayList<Site> sl = new ArrayList<Site>();
        			sl.add(new Site("Trust HQ, Central & North West London", "N0000692", "W2 6LA", g));
        			g.setSites(sl);
        		}
        		...
        		if(g.getName().equals("006002")){
        			ArrayList<Site> sl = new ArrayList<Site>();
        			sl.add(new Site("Prestwich Hospital", "N0000686", "M25 3BL", g));
        			g.setSites(sl);
        		}
        		if(g.getName().equals("007001")){
        			ArrayList<Site> sl = new ArrayList<Site>();
        			sl.add(new Site("Bethlem Royal Hospital", "N0000694", "SE5 8AZ", g));
        			g.setSites(sl);
        		}
        		if(g.getName().equals("008001")){
        			ArrayList<Site> sl = new ArrayList<Site>();
        			sl.add(new Site("Trust HQ, Birmingham and Solihull", "N0000696", "B1 3RB", g));
        			g.setSites(sl);
        		}
        }
    }
