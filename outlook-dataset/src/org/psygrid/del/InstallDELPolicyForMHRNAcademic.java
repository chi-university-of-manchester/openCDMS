 ...
 *
 */
public class InstallDELPolicyForMHRNAcademic {
	...
	public static void main(String[] args){
		...
		try {
			...
			pdt.setAuthorities(new AuthorityType[]{new AuthorityType("1.2.840.113549.1.9.1=#161473797361646d696e40707379677269642e6f7267,CN=mhrn-nhs-aa,OU=Informatics,O=PsyGrid,C=UK")});
			/*
