 ...
 *
 */
final public class UnitWrapper {

	   /**
	    * A reference to a possibly alternate factory.
	    */
	   static private IUnitFactory _factory = null;
	    ...
	    */
	   static private Units makeInstance() {
	      return new Units();
	   }
	    ...
	    */
	   static public synchronized Units instance() {
	      if(null == _instance) {
	    ...
	    */
	   static public synchronized void setFactory(IUnitFactory factory) {
	      _factory = factory;
	   }
	    ...
	    */
	   static public synchronized void setInstance(Units instance) {
	      _instance = instance;
	   }
}
