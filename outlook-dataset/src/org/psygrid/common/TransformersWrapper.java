...
public class TransformersWrapper {
	    ...
	    */
	   static private ITransformersFactory _factory = null;

	   /**
	    * A reference to the current instance.
	    */
	   static private Transformers _instance = null;
	    ...
	    */
	   static private Transformers makeInstance() {
	    ...
	    */
	   static public synchronized Transformers instance() {
	      if(null == _instance) {
	    ...
	    */
	   static public synchronized void setFactory(ITransformersFactory factory) {
	      _factory = factory;
	   }
	    ...
	    */
	   static public synchronized void setInstance(Transformers instance) {
	      _instance = instance;
	   }
}
