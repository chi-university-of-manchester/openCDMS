...
public class AdminInfo implements IAdminInfo {
	...
	public AdminInfo(DataElementAction action, String description, boolean elementActive, String registrar, String terminologicalReference){
	...
	public org.psygrid.data.model.dto.AdminInfo toDTO() {
		org.psygrid.data.model.dto.AdminInfo dtoAI = new org.psygrid.data.model.dto.AdminInfo();

		dtoAI.setActionTaken(actionTaken);
		dtoAI.setDescription(description);
		dtoAI.setElementActive(elementActive);
		dtoAI.setRegistrar(registrar);
		dtoAI.setTerminologicalReference(terminologicalReference);
		dtoAI.setWho(who);
