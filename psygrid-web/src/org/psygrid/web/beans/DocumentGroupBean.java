...
public class DocumentGroupBean {
	...
	public DocumentGroupBean(long id, String name){
		this.id = id;
		this.name = name;
	}
	...
	public void addDocOcc(DocumentOccurrenceBean dob){
		this.docOccs.add(dob);
	}
	
	public void addDocOcc(long id, String name){
		this.docOccs.add(new DocumentOccurrenceBean(id, name));
	}
