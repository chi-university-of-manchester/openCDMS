	...
	<head>
		...
		<form method="post" action="managementreport.html" class="report">
			<fieldset>
					...
					<p>
					<spring:bind path="report.documentid">	
					<label for="documentid">Documents: </label>
					<select name="documentid" id="documentid" class="select-width">
				...
				<div>
					...
					<input type="submit" name="_target4" value="Back" id="back" />
					<label for="submit"> </label>
					<input type="submit" value="Continue" name="_target6" id="submit" />
				</div>
			</fieldset>
		</form>
