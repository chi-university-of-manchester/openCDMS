-- Patch to FIX the t_bcc_addresses and t_randomisation_email tables for 
...
create table t_randomisation_email (c_id bigint not null, c_body clob(4096), c_subject varchar(255), c_to_address varchar(255), c_from_address varchar(255), primary key (c_id));
