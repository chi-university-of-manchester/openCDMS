...
public class AEFAction  implements java.io.Serializable {
    ...
    public AEFAction(ActionType at) {
		name = at.getName();
		idCode = at.getIdCode();
	}
    ...
    /**
     * Gets the idCode value for this ActionType.
     * 
     * @return idCode
     */
    ...
    /**
     * Sets the idCode value for this ActionType.
     * 
     * @param idCode
     */
