...
public class IntegerRendererTest extends AbstractEntryTestCase {
    ...
    private IntegerEntry optionalEntry;
    ...
    protected void setUp() throws Exception {
        ...
        entry = factory.createIntegerEntry("Name", "Name");
        entry.setSection(section);
        doc.addEntry(entry);
        
        optionalEntry = factory.createIntegerEntry("Optional entry", "optional entry");
        ...
        NumericRendererSPI tRenderer = new IntegerRendererSPI();
        NumericRendererSPI oRenderer = new IntegerRendererSPI();
        ...
        BasicRenderer<?> optionalRenderer = (BasicRenderer<?>) oRenderer.getRenderer(
                new RendererData(rendererHandler, optionalEntry, null, 0, null,
                        false, EditableStatus.DEFAULT));
    ...
    public void testGetRendererSPI() {
        ...
        assertTrue(rspi instanceof IntegerRendererSPI);
    }
