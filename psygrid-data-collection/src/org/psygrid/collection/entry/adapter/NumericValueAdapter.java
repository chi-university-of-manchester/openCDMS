...
public class NumericValueAdapter extends ValueAdapter implements INumericValue {
    
    public NumericValueAdapter(INumericValue value) {
        super(value);
    }
    
    public Double getValue() {
        return ((INumericValue) value).getValue();
    }

    public void setValue(Double value) throws ModelException {
        ((INumericValue) this.value).setValue(value);
    }

    @Override
    public INumericValue copy() {
        return (INumericValue) super.copy();
    }
    
    @Override
    public NumericValueAdapter copyAdapter() {
        NumericValueAdapter adapterCopy = new NumericValueAdapter(copy());
