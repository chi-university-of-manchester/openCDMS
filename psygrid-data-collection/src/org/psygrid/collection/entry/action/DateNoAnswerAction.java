...
public class DateNoAnswerAction extends NoAnswerAction {
    ...
    private DatePresModel presModel;
    private PartialDateModeAction enablePartialAction;
    public DateNoAnswerAction(StandardCode standardCode, DatePresModel presModel,
            Action enableEditingAction, DatePicker datePicker,
            PartialDateModeAction enablePartialAction) {
        super(standardCode, presModel.getDisplayTextModel(), 
                presModel.getStandardCodeModel(), enableEditingAction);
    ...
    public void actionPerformed(ActionEvent e) {
        if (datePicker.isPartialDateMode()) {
            datePicker.setPartialDateMode(false);
            datePicker.revalidate();
            datePicker.repaint();
        }
        enablePartialAction.setName();
        enablePartialAction.setEnabled(false);
