...
public final class MarkResponseAsValidWorker extends SwingWorker<Object, Object> {

    private final MarkResponseValidAction action;
    private final ResponsePresModel presModel;
    public MarkResponseAsValidWorker(ResponsePresModel presModel, 
    		MarkResponseValidAction action) {
    ...
    protected Object doInBackground() throws ConnectException, SocketTimeoutException, RemoteServiceFault,
        ...
        RemoteManager.getInstance().markResponseAsValid(presModel.getResponse());
        //DUAL DATA ENTRY
        if ( null != presModel.getResponse().getRecord().getSecondaryRecord() ){
            ...
            RemoteManager.getInstance().markResponseAsValid(secResp);        
        }
        return null;
    }
