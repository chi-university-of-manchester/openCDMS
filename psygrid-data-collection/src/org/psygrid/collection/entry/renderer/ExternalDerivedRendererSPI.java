...
public class ExternalDerivedRendererSPI implements RendererSPI {

    public boolean canHandle(Entry modelObject, Entry parent) {
    	if (modelObject instanceof ExternalDerivedEntry) {
            return true;
        }
        return false;
    }
    ...
    public Renderer getRenderer(RendererData rendererData) {
    	return new ExternalDerivedRendererSPIDelegate(rendererData).getRenderer();
    }
