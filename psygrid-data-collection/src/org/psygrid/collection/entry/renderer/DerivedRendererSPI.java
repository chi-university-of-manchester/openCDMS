...
public class DerivedRendererSPI implements RendererSPI {

    public boolean canHandle(Entry modelObject, Entry parent) {
        if (modelObject instanceof DerivedEntry) {
            return true;
        }
        return false;
    }
    ...
    public Renderer getRenderer(RendererData rendererData) {
        return new DerivedRendererSPIDelegate(rendererData).getRenderer();
    }
}
