...
public class ForceChangePasswordDialog extends ChangePasswordDialog {
	...
	private static final long serialVersionUID = 7809632974597310779L;
	...
	private class CloseWindowAdapter extends WindowAdapter {
		public void windowClosing(WindowEvent e) {
			int n = JOptionPane.showConfirmDialog(
	                (JFrame)getOwner(), Messages.getString("ForceChangePasswordDialog.appwillexit") +
	                Messages.getString("ForceChangePasswordDialog.appwishtoexit"),
	                Messages.getString("ForceChangePasswordDialog.confirmexit"),
