...
/**
 * Utility class to decrypt an encrypted file.
 * <p>
 * Usage: DecryptFile &lt;input file&gt; &lt;output file&gt; &lt;password&gt;
 * 
 * @author Rob Harper
 *
 */
public class DecryptFile {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            //load encrypted file
            String encrypted = loadToString(args[0]);
            
            //decrypt file
            String plainText = SecurityHelper.decrypt(encrypted, args[2].toCharArray());
            
            //write plaintext to file
            saveString(plainText, args[1]);
