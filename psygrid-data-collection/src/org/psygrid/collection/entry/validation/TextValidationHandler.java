...
public class TextValidationHandler implements PropertyChangeListener {

	private static final Log LOG = LogFactory.getLog(TextValidationHandler.class);
    ...
    public TextValidationHandler(TextPresModel model) {
        this.model = model;
        this.valueModel = model.getValueModel();
        this.stdCodeModel = model.getStandardCodeModel();
        result = new ValidationResult();
        result.addError(Messages.getString("TextValidationHandler.tooLong")); //$NON-NLS-1$
    }
