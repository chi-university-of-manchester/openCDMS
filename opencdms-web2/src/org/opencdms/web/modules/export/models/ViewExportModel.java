 ...
 *
 */
public class ViewExportModel implements Serializable {

	private static final long serialVersionUID = 1L;

	private ProjectType study;
	
	transient private List<ExportRequest> requests;
	...
	public List<ExportRequest> getRequests() {
		return requests;
	}

	public void setRequests(List<ExportRequest> requests) {
