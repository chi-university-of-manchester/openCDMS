...
import org.opencdms.web.core.security.details.PsygridUserDetails;
...
public class PsygridLdapUserDetailsImpl implements LdapUserDetails, PsygridUserDetails {
    ...
    private List<ProjectType> importableProjects;
    private List<ProjectType> auditableProjects;
    private List<ProjectType> immediatelyExportableProjects;
    private List<ProjectType> queryableProjects;
    private List<ProjectType> prExportableProjects;
    ...
    /**
     * This constructor should be used for TESTING ONLY where proper
     * authentication is not performed (for ease of development).
     * 
     * @param username
     * @param password
     * @param pgDn
     ...
     * @param authorities
     */
    public PsygridLdapUserDetailsImpl(String username, String password, String pgDn, 
    		List<ProjectType> projects, Map<ProjectType, List<GroupType>> groups, GrantedAuthority[] authorities){
    	this.username = username;
    	this.password = password;
    	this.pgDn = pgDn;
		this.projects = projects;
		this.exportableProjects = projects;
		this.auditableProjects = projects;
		this.immediatelyExportableProjects = projects;
		this.queryableProjects = projects;
		this.groups = groups;
    	this.authorities = authorities;
    	this.globalAuthorities = authorities;
    }
	...
	public List<ProjectType> getImportableProjects() {
		return importableProjects;
	}

	public void setImportableProjects(List<ProjectType> importableProjects) {
		this.importableProjects = importableProjects;
	}
	...
	public List<ProjectType> getQueryableProjects() {
		return queryableProjects;
	}

	public void setQueryableProjects(List<ProjectType> queryableProjects) {
		this.queryableProjects = queryableProjects;
	}
	
	public List<ProjectType> getPrExportableProjects() {
		return prExportableProjects;
	}

	public void setPrExportableProjects(List<ProjectType> prExportableProjects) {
		this.prExportableProjects = prExportableProjects;
	}
