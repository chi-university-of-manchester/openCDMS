...
/**
 * Wizard descriptor for the multi centre wizard page
 * @author pwhelan
 */
public class MultiCentreDescriptor extends WizardPanelDescriptor {

	//identifier
	public static final String IDENTIFIER = "MULTI_CENTRE_PANEL";
     ...
     */
    public MultiCentreDescriptor(JDialog parentDialog, WizardModel wm) {
        super(IDENTIFIER, new MultiCentrePanel(parentDialog, wm));
    }
    ...
    public Object getBackPanelDescriptor() {
        return BasicPropertiesDescriptor.IDENTIFIER;
    }  
