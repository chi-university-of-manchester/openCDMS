...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
    ...
    public Wizard(Frame owner) {
		LOG.info("Wizard : creating new wizard"); //$NON-NLS-1$
        wizardModel = new WizardModel();
        wizardDialog = new JDialog(owner);
        initComponents();
    }
    ...
    public void registerWizardPanel(Object id, WizardPanelDescriptor panel) {
        ...
        cardPanel.add(new JScrollPane(panel.getPanelComponent()), id);
   ...
   /**
    ...
    private void initComponents() {
        ...
        wizardDialog.getContentPane().setPreferredSize(new Dimension(700, 420));
        wizardDialog.getContentPane().setMaximumSize(new Dimension(700, 420));
        wizardDialog.getContentPane().setMinimumSize(new Dimension(700, 420));
        ...
        backButton = new JButton(IconsHelper.getInstance().getImageIcon("back.png"));
        nextButton = new JButton(IconsHelper.getInstance().getImageIcon("forward.png"));
        cancelButton = new JButton();
        
        //manually set size of iconless Cancel Button
        ...
        //set cancel button to be the same size as back button
    ...
    static {
        ...
        try { 
            ...
            PropertyResourceBundle resources = (PropertyResourceBundle)
                ResourceBundle.getBundle("org.psygrid.datasetdesigner.properties.wizard");
