...
package org.psygrid.datasetdesigner;
...
public class LogConfigurator {
	...
	private static final String LOG_PROPERTIES = "org/psygrid/datasetdesigner/logging.properties"; //$NON-NLS-1$

	final private URL logPropertiesURL;
	...
	public LogConfigurator() throws IOException {
		 ...
		 * See Bug #962
		 */
		String home = PersistenceManager.getInstance().getHomeDir("dsd");
