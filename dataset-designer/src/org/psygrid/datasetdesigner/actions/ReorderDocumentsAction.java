...
import org.psygrid.datasetdesigner.ui.configurationdialogs.ReorderDocumentsDialog;
 ...
 * @author pwhelan
 */
public class ReorderDocumentsAction extends AbstractAction
{
	/**
	 ...
	 */
	public ReorderDocumentsAction(MainFrame frame, boolean isDEL) {
		super(PropertiesHelper.getStringFor("org.psygrid.datasetdesigner.actions.reorderdocuments"));
		this.frame = frame;
		this.isDEL = isDEL;
	}
	...
	public void actionPerformed(ActionEvent e) {
		new ReorderDocumentsDialog(frame, isDEL);
	}
