 ...
 * @author pwhelan
 */
public class PatchDatasetAction extends AbstractAction {
	 ...
	 */
	public PatchDatasetAction(MainFrame mainFrame) {
		super(PropertiesHelper.getStringFor("org.psygrid.datasetdesigner.actions.patchdataset"));
	...
	public void actionPerformed(ActionEvent e) {
		DatasetUtility.patchDataset(mainFrame);
	}
