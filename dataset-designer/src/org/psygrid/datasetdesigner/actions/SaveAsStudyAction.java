 ...
 * @author pwhelan
 */
public class SaveAsStudyAction extends AbstractAction {
	...
	/**
	 * Save a new study window
	 *@param mainFrame the main window of the application
	 */
	public SaveAsStudyAction(MainFrame mainFrame) {
		super(PropertiesHelper.getStringFor("org.psygrid.datasetdesigner.actions.saveasstudy"));
	...
	public void actionPerformed(ActionEvent e) {
		DatasetUtility.saveAsDataset(mainFrame);
	}	
