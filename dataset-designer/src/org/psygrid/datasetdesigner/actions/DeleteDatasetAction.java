...
public class DeleteDatasetAction extends AbstractAction {
	...
	private static final Log LOG = LogFactory.getLog(DeleteDatasetAction.class);

	public DeleteDatasetAction(MainFrame frame) {
		super(PropertiesHelper.getStringFor("org.psygrid.datasetdesigner.actions.deletepublisheddataset"));
		this.frame = frame;
	}
	...
	public void actionPerformed(ActionEvent aet) {
		...
		int n = JOptionPane.showConfirmDialog (
				frame, "Are you sure you want to delete the study?",
				"Confirm Delete",
			...
			refreshSecurityKey();
				SwingWorker<Object, Object> worker = new SwingWorker<Object, Object>() {
					public Object doInBackground() {
						...
						//the remove the randomisation  - try to remove anyway
						removeRandomisation(dsCode);

		
						
						//remove the dataset
						client.removePublishedDataSet(dsSummary.getId(), dsCode, 
