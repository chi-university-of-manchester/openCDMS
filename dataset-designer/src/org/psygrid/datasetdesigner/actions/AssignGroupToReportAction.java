...
public class AssignGroupToReportAction extends AbstractAction {
	...
	public AssignGroupToReportAction(JList leftList, JList rightList, int type) {
    	super("", IconsHelper.getInstance().getImageIcon("Forward16.png"));
    	this.leftList = leftList;
    	this.rightList = rightList;
	}	    
	
	public AssignGroupToReportAction(JList leftList, JList rightList) {
    	super("", IconsHelper.getInstance().getImageIcon("Forward16.png"));
    	this.leftList = leftList;
    	this.rightList = rightList;
	}
