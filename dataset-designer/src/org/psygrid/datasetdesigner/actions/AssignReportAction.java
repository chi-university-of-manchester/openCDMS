...
public class AssignReportAction extends AbstractAction {
	
	private JList leftList;
	private JList rightList;
	
	public AssignReportAction( 
							  JComboBox datasetBox, 
							  JList leftList,
							  JList rightList,
							  HashMap reportsMap,
							  HashMap allReportsMap) {
	...
	public void actionPerformed(ActionEvent aet) {
		Object[] selectedLefts = leftList.getSelectedValues();
		for (int i=0; i<selectedLefts.length; i++) {
			Object selectedLeft = selectedLefts[i];
