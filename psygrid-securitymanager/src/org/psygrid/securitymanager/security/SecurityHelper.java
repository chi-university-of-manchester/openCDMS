 ...
 * 
 * Stolen from CoCoA and adapted for use here.
 *
 */
public class SecurityHelper {
    ...
    private static boolean UNLIMITED_CRYPTOGRAPHY = false;
    ...
    public static final String PACKAGE = "org/psygrid/securitymanager/security/keystores/"; //$NON-NLS-1$
    public static final String PROPERTIES_PACKAGE = "org/psygrid/securitymanager/properties/";
    ...
    static {
        ...
        try {
            in = Thread.currentThread().getContextClassLoader().
                    getResourceAsStream(PROPERTIES_PACKAGE + "security.properties"); //$NON-NLS-1$
    ...
    public static AAQueryClient getAAQueryClient() throws ConnectException {
    	
    	if (!SecurityManager.getInstance().getImportedCert())
    	{
        	try
        	{
            	SecurityManager.getInstance().refreshKey(true);
        	} catch (Exception ex)
        	{
        		//what can we do?
        	}
        ...
        try {
        	...
        	client = new AAQueryClient(endPointAddress, PersistenceManager.getInstance().getTrustStoreLocation(), 
            		TRUST_STORE_PASSWORD, PersistenceManager.getInstance().getKeyStoreLocation(), 
            		System.getProperty("javax.net.ssl.keyStorePassword"));
        } catch (PGSecurityException e) {
            //Should not happen (it's wrapping a ServiceException) 
            wrapIntoRuntimeExceptionAndThrow(e);
            LOG.error("SecurityHelper : getting AAQueryClient " + e.getMessage());
        } catch (Exception ex)
        {
        	LOG.error("SecurityHelper : getting AAQueryClient : " + ex.getMessage());
    ...
    public static AAManagementClient getAAManagementClient()  {
        ...
        try {
            String trustStoreLocation = 
                PersistenceManager.getInstance().getTrustStoreLocation();
            client = new AAManagementClient(endPointAddress, PersistenceManager.getInstance().getTrustStoreLocation(), 
            		TRUST_STORE_PASSWORD, PersistenceManager.getInstance().getKeyStoreLocation(), 
            		System.getProperty("javax.net.ssl.keyStorePassword"));
        } catch (PGSecurityException e) {
            //Should not happen (it's wrapping a ServiceException) 
            wrapIntoRuntimeExceptionAndThrow(e);
            LOG.error("SecurityHelper : getting AAManagementClient " + e.getMessage());
        } catch (Exception ex)
        {
        	LOG.error("SecurityHelper : getting AAManagementClient " + ex.getMessage());
        }
    ...
    static void wrapIntoRuntimeExceptionAndThrow(Exception e)   {
    	//        ExceptionsHelper.wrapIntoRuntimeExceptionAndThrow(e);
    }
    ...
    public static PAQueryClient getPAQueryClient() {
        ...
        try {
            String trustStoreLocation = 
                PersistenceManager.getInstance().getTrustStoreLocation();
            client = new PAQueryClient(endPointAddress, PersistenceManager.getInstance().getTrustStoreLocation(), 
            		TRUST_STORE_PASSWORD, PersistenceManager.getInstance().getKeyStoreLocation(), 
            		System.getProperty("javax.net.ssl.keyStorePassword"));
        } catch (PGSecurityException e) {
            //Should not happen (it's wrapping a ServiceException) 
    ...
    public static PAManagementClient getPAManagementClient() {
        ...
        try {
            String trustStoreLocation = 
                PersistenceManager.getInstance().getTrustStoreLocation();
            client = new PAManagementClient(endPointAddress, PersistenceManager.getInstance().getTrustStoreLocation(), 
            		TRUST_STORE_PASSWORD, PersistenceManager.getInstance().getKeyStoreLocation(), 
            		System.getProperty("javax.net.ssl.keyStorePassword"));
        } catch (PGSecurityException e) {
            //Should not happen (it's wrapping a ServiceException) 
